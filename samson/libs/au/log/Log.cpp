...
std::string Log::get(std::string name) {
  ...
  if (name == "HOST")
    return getField("host", ""); if (name == "TYPE")
    return au::str("%c", log_data.type); if (name == "PID")
    return au::str("%d", log_data.pid); if (name == "TID")
    return au::str("%d", log_data.tid); if (name == "DATE") {
    char line_tmp[80];
    struct tm tmP;
  ...
  if (name == "LINE")
    return au::str("%d", log_data.lineNo); if (name == "TLEV")
    return au::str("%d", log_data.traceLevel); if (name == "EXEC")
    return getField("progName", ""); if (name == "AUX")
    return getField("aux", ""); if (name == "FILE")
    return getField("file", ""); if (name == "TEXT")
    return getField("text", ""); if (name == "text") {
  ...
  if (name == "FUNC")
    return getField("fname", ""); if (name == "STRE")
