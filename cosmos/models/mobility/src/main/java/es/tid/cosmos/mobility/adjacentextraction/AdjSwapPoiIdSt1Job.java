 ...
 * @author dmicol
 */
public class AdjSwapPoiIdSt1Job extends Job {
    private static final String JOB_NAME = "AdjSwapPoiIdSt1";

    public AdjSwapPoiIdSt1Job(Configuration conf) throws IOException {
        super(conf, JOB_NAME);
        ...
        this.setReducerClass(AdjSwapPoiIdSt1Reducer.class);
    }
