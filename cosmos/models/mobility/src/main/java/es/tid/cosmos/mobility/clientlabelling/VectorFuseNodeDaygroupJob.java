 ...
 * @author dmicol
 */
public class VectorFuseNodeDaygroupJob extends Job {
    private static final String JOB_NAME = "VectorFuseNodeDaygroup";

    public VectorFuseNodeDaygroupJob(Configuration conf) throws IOException {
        super(conf, JOB_NAME);
        ...
        this.setReducerClass(VectorFuseNodeDaygroupReducer.class);
    }
