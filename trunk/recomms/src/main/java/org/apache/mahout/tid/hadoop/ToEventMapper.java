...
public abstract class ToEventMapper extends
        Mapper<Object, Object, VarLongWritable, VarLongWritable> {

    private boolean booleanData;

    public static final long PURCHASE = 0;
    public static final long RATE = 1;
    public static final long RECODISPLAY = 2;
    public static final long CLICK = 3;
    public static final long VIEW = 4;

    public boolean itemKey;

    ToEventMapper(boolean itemKey) {
    ...
    public void map(Object key, Object value, Context context)
        ...
        if (type.equals(new String("rate")))
            eventType = RATE;
        else if (type.equals(new String("view")))
            eventType = VIEW;
        else if (type.equals(new String("click")))
            eventType = CLICK;
        else if (type.equals(new String("recodisplay")))
            eventType = RECODISPLAY;
        else
            eventType = PURCHASE;
