 ...
 * @author dmicol
 */
public class PoiSpreadNodebtsVectorJob extends Job {
    private static final String JOB_NAME = "PoiSpreadNodebtsVector";

    public PoiSpreadNodebtsVectorJob(Configuration conf) throws IOException {
        super(conf, JOB_NAME);
        ...
        this.setReducerClass(PoiSpreadNodebtsVectorReducer.class);
    }
