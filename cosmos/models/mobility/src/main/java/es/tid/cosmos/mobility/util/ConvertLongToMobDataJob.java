 ...
 * @author dmicol
 */
public class ConvertLongToMobDataJob extends Job {
    private static final String JOB_NAME = "ConvertLongToMobData";

    public ConvertLongToMobDataJob(Configuration conf)
            throws IOException {
        super(conf, JOB_NAME);
        ...
        this.setReducerClass(ConvertLongToMobDataReducer.class);
    }
