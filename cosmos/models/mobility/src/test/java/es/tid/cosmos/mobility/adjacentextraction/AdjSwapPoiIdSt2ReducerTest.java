...
public class AdjSwapPoiIdSt2ReducerTest {
    ...
    public void setUp() {
        this.driver = new ReduceDriver<LongWritable,
                ...
                TypedProtobufWritable<TwoInt>>(new AdjSwapPoiIdSt2Reducer());
    }
    ...
    public void testReducer() {
        ...
        TypedProtobufWritable<TwoInt> out4 = new TypedProtobufWritable<TwoInt>(
                TwoInt.newBuilder().setNum1(6L).setNum2(500L).build());
        this.driver
                .withInput(key, Arrays.asList(record1, record2, record3,
                                              record4, record5, record6))
                .withOutput(new LongWritable(1L), out1)
                .withOutput(new LongWritable(3L), out2)
