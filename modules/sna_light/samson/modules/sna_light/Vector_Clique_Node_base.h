...
#ifndef _H_SAMSON_sna_light_Vector_Clique_Node_BASE
#define _H_SAMSON_sna_light_Vector_Clique_Node_BASE
...
namespace sna_light{
	...
	void copyFrom( Vector_Clique_Node_base *other ){
