...
public class RecommenderTIDJobTest extends TasteTestCase {
    ...
    public void testItemIDIndexMapper() throws Exception {
        ...
        new ItemIDIndexMapper().map(new Object(), (BSONObject) event, context);
    ...
    public void testItemIDIndexReducer() throws Exception {
        ...
        new ItemIDIndexReducer().reduce(new VarIntWritable(123), Arrays.asList(
                new VarLongWritable(67L), new VarLongWritable(89L),
     ...
     */
    static RecommendedItemsWritable recommendationsMatch(
    ...
    public void testRecommendedItemsWritable() throws Exception {
        ...
        RecommendedItemsWritable recommended = new RecommendedItemsWritable();
    ...
    public void testCompleteJob() throws Exception {
        ...
        recommenderJob.run(new String[] { "--input",
                ...
                Resources.getResource("recommender.properties").getFile(),
