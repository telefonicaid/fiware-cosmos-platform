...
#ifndef _H_SAMSON_test_compareFunctions_red_expense_by_companyAge
#define _H_SAMSON_test_compareFunctions_red_expense_by_companyAge
...
input: system.UInt test_compareFunctions.User  compareValueFunction=compare_by_age
