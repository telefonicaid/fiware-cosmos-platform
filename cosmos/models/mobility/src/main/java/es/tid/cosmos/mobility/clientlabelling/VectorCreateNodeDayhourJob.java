 ...
 * @author dmicol
 */
public class VectorCreateNodeDayhourJob extends Job {
    private static final String JOB_NAME = "VectorCreateNodeDayhour";

    public VectorCreateNodeDayhourJob(Configuration conf) throws IOException {
        super(conf, JOB_NAME);
        ...
        this.setReducerClass(VectorCreateNodeDayhourReducer.class);
    }
