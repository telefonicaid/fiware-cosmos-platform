 ...
 * @author dmicol
 */
public class ClusterAggNodeClusterByNodlblJob extends Job {
    private static final String JOB_NAME = "ClusterAggNodeClusterByNodlbl";

    public ClusterAggNodeClusterByNodlblJob(Configuration conf)
            throws IOException {
        super(conf, JOB_NAME);
        ...
        this.setReducerClass(ClusterAggNodeClusterByNodlblReducer.class);
    }
