 ...
 * @author dmicol
 */
public class AdjChangePoisIdJob extends Job {
    private static final String JOB_NAME = "AdjChangePoisId";

    public AdjChangePoisIdJob(Configuration conf) throws IOException {
        super(conf, JOB_NAME);
        ...
        this.setReducerClass(AdjChangePoisIdReducer.class);
    }
