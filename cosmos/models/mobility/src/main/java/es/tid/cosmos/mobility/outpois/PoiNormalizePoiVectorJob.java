 ...
 * @author dmicol
 */
public class PoiNormalizePoiVectorJob extends Job {
    private static final String JOB_NAME = "PoiNormalizePoiVector";

    public PoiNormalizePoiVectorJob(Configuration conf) throws IOException {
        super(conf, JOB_NAME);
        ...
        this.setReducerClass(PoiNormalizePoiVectorReducer.class);
    }
