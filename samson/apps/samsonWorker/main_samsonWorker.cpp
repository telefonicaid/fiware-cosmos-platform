...
{
  SAMSON_ARGS,
  { "-zk",          zoo_host,     "", PaString, PaOpt, _i "localhost:2181",    PaNL, PaNL,    "Zookeeper server"   },
  ...
  { "-monit",       &monit,       "", PaBool,   PaOpt, false,                  false,  true,  "to use with monit"                 },
  ...
  { "-valgrind",    &valgrind,    "", PaInt,    PaOpt, 0,                      0,        20,  "help valgrind debug process"       },
