...
public class AggregateCalculatorQueries {
    final static public String PAGES_VIEWS_BY_PROT_VIS_DEV = "INSERT OVERWRITE TABLE AG_PAGE_VIEWS_VIS_DEV "
            + "SELECT "
    ...
    final static public String PAGES_VIEWS_BY_PROT_VIS = "INSERT OVERWRITE TABLE AG_PAGE_VIEWS_VIS "
            + "SELECT "
    ...
    final static public String PAGES_VIEWS_BY_PROT_DEV = "INSERT OVERWRITE TABLE AG_PAGE_VIEWS_DEVICE "
            + "SELECT "
    ...
    final static public String PAGES_VIEWS_BY_PROT_METHOD = "INSERT OVERWRITE TABLE AG_PAGE_VIEWS_METHOD "
            + "SELECT "
    ...
    final static public String PAGES_VIEWS_BY_PROTOCOL = "INSERT OVERWRITE TABLE AG_PAGE_VIEWS "
            + "SELECT "
    ...
    final static public String VISITORS_BY_PROTOCOL = "INSERT OVERWRITE TABLE AG_VISITORS "
            + "SELECT "
            + "a.protocol, a.date_view, count(*) "
            + "FROM "
            + "ag_page_views_vis a " + "GROUP BY " + "a.protocol, a.date_view";

    final static public String PAGES_VIEWS_BY_PROT_URL_VIS = "INSERT OVERWRITE TABLE AG_PAGE_VIEWS_URL_VIS "
            + "SELECT "
    ...
    final static public String VISITORS_BY_PROT_URL = "INSERT OVERWRITE TABLE AG_VISITORS_URL "
            + "SELECT "
    ...
    final static public String PAGES_VIEWS_BY_PROT_DOM_VIS = "INSERT OVERWRITE TABLE AG_PAGE_VIEWS_DOM_VIS "
            + "SELECT "
    ...
    final static public String PAGES_VIEWS_BY_PROT_DOM = "INSERT OVERWRITE TABLE AG_PAGE_VIEWS_DOM "
            + "SELECT "
    ...
    final static public String VISITORS_BY_PROT_DOM = "INSERT OVERWRITE TABLE AG_VISITORS_DOM "
            + "SELECT "
    ...
    final static public String PAGES_VIEWS_BY_PROT_CAT = "INSERT OVERWRITE TABLE AG_PAGE_VIEWS_CCAT "
            + "SELECT "
    ...
    final static public String VISITORS_BY_CATEGORY = "INSERT OVERWRITE TABLE AG_VISITORS_CCAT "
            + "SELECT "
    ...
    final static public String SEARCHES_BY_PROT_QKEY_VIS_SEARCHER = "INSERT OVERWRITE TABLE AG_SEARCHES_KEY_VIS_SEA "
            + "SELECT "
    ...
    final static public String SEARCHES_BY_PROT_QKEY_VIS = "INSERT OVERWRITE TABLE AG_SEARCHES_KEY_SEA "
            + "SELECT "
