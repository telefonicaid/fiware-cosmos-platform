...
namespace ss
{
    ...
    void ProcessItemIsolated::sendMessageProcessPlatform(ss::network::MessageProcessPlatform *message )
    {
        ...
        if( response->code() == ss::network::MessagePlatformProcess_Code_code_kill )
        {
	...
	void ProcessItemIsolated::sendCode( int c )
	{
        ...
        ss::network::MessageProcessPlatform *message = new ss::network::MessageProcessPlatform();
        message->set_code( ss::network::MessageProcessPlatform_Code_code_operation );
	...
	void ProcessItemIsolated::setUserError( std::string error_message )
	{
        ...
        ss::network::MessageProcessPlatform *message = new ss::network::MessageProcessPlatform();
        message->set_code( ss::network::MessageProcessPlatform_Code_code_user_error );
	...
	void ProcessItemIsolated::trace( LogLineData *logData )
	{
        ...
        ss::network::MessageProcessPlatform *message = new ss::network::MessageProcessPlatform();
        message->set_code( ss::network::MessageProcessPlatform_Code_code_trace );

        ss::network::Trace *trace = message->mutable_trace( );
	...
	void ProcessItemIsolated::reportProgress( double p )
	{
        ...
        ss::network::MessageProcessPlatform *message = new ss::network::MessageProcessPlatform();
        message->set_code( ss::network::MessageProcessPlatform_Code_code_progress );
	...
	void ProcessItemIsolated::runBackgroundProcessRun()
	{
        ...
        {
            ss::network::MessageProcessPlatform *message = new ss::network::MessageProcessPlatform();
            message->set_code( ss::network::MessageProcessPlatform_Code_code_begin );
            sendMessageProcessPlatform(message);
            delete message;
        }        
        ...
        {
            ss::network::MessageProcessPlatform *message = new ss::network::MessageProcessPlatform();
            message->set_code( ss::network::MessageProcessPlatform_Code_code_end );
            sendMessageProcessPlatform(message);
            delete message;
        }
