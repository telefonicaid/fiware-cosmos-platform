...
import es.tid.cosmos.mobility.labelling.client.*;
 ...
 * @author dmicol
 */
public class PoiJoinPoisBtscoordToPoiPosJob extends Job {
    private static final String JOB_NAME = "PoiJoinPoisBtscoordToPoiPos";

    public PoiJoinPoisBtscoordToPoiPosJob(Configuration conf)
            throws IOException {
        super(conf, JOB_NAME);
