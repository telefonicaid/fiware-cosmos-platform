 ...
 * @author dmicol
 */
public class ExportBtsCounterToTextByTwoIntJob extends Job {
    private static final String JOB_NAME = "ExportBtsCounterToTextByTwoInt";

    public ExportBtsCounterToTextByTwoIntJob(Configuration conf)
            throws IOException {
        super(conf, JOB_NAME);
        ...
        this.setReducerClass(ExportBtsCounterToTextByTwoIntReducer.class);
    }
