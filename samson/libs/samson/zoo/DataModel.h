...
public:
  ...
  void ProcessAddCommand(au::SharedPointer<gpb::Data> data, const au::CommandLine& /* cmd */,
  ...
  void ProcessAddStreamOperationCommand(au::SharedPointer<gpb::Data> data, const au::CommandLine& /* cmd */,
                                        int version, au::ErrorManager */* error */);
  void ProcessBatchCommand(au::SharedPointer<gpb::Data> data, const au::CommandLine& /* cmd */,
                           int version, au::ErrorManager */* error */);
  void ProcessBlockCommand(au::SharedPointer<gpb::Data> data, const au::CommandLine& /* cmd */,
                           int version, au::ErrorManager */* error */);
  void ProcessClearBatchOPerationsCommand (au::SharedPointer<gpb::Data> data, const au::CommandLine& /* cmd */,
                                              int version, au::ErrorManager */* error */);
  void ProcessClearModulesCommand (au::SharedPointer<gpb::Data> data, const au::CommandLine& /* cmd */,
                                              int version, au::ErrorManager */* error */);
  void ProcessPushQueueCommand (au::SharedPointer<gpb::Data> data, const au::CommandLine& /* cmd */,
                                              int version, au::ErrorManager */* error */);
  void ProcessRemoveAllCommand (au::SharedPointer<gpb::Data> data, const au::CommandLine& /* cmd */,
                                              int version, au::ErrorManager */* error */);
  void ProcessRemoveAllDataCommand (au::SharedPointer<gpb::Data> data, const au::CommandLine& /* cmd */,
                                              int version, au::ErrorManager */* error */);
  ...
  void ProcessRemoveStreamOperationCommand (au::SharedPointer<gpb::Data> data, const au::CommandLine& /* cmd */,
                                              int version, au::ErrorManager */* error */);
  void ProcessRmCommand (au::SharedPointer<gpb::Data> data, const au::CommandLine& /* cmd */,
                                              int version, au::ErrorManager */* error */);
  ...
  void ProcessSetStreamOperationPropertyCommand (au::SharedPointer<gpb::Data> data, const au::CommandLine& /* cmd */,
                                              int version, au::ErrorManager */* error */);
  void ProcessUnsetStreamOperationPropertyCommand (au::SharedPointer<gpb::Data> data, const au::CommandLine& /* cmd */,
                                              int version, au::ErrorManager */* error */);
