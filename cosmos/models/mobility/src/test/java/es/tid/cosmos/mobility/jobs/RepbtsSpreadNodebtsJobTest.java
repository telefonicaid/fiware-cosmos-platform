...
import es.tid.cosmos.mobility.jobs.RepbtsSpreadNodebtsJob;
 ...
 * @author dmicol
 */
public class RepbtsSpreadNodebtsJobTest {
    private RepbtsSpreadNodebtsJob instance;
    
    @Before
    public void setUp() throws IOException {
        this.instance = new RepbtsSpreadNodebtsJob(new Configuration());
    }
