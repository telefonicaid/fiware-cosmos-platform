...
public class MatrixGetVectorReducerTest {
    private ReduceDriver<ProtobufWritable<ItinRange>,
            MobilityWritable<ItinPercMove>, ProtobufWritable<TwoInt>,
    ...
    public void setUp() {
        this.instance = new ReduceDriver<ProtobufWritable<ItinRange>,
            MobilityWritable<ItinPercMove>, ProtobufWritable<TwoInt>,
            MobilityWritable<ClusterVector>>(new MatrixGetVectorReducer());
    }
    ...
    public void testReduce() throws IOException {
        final ProtobufWritable<ItinRange> key = ItinRangeUtil.createAndWrap(
                1, 2, 3, 4, 5);
        final MobilityWritable<ItinPercMove> value1 = new MobilityWritable<ItinPercMove>(
                ItinPercMoveUtil.create(0, 7, 8.9D));
        final MobilityWritable<ItinPercMove> value2 = new MobilityWritable<ItinPercMove>(
                ItinPercMoveUtil.create(6, 11, 12.13D));
        List<Pair<ProtobufWritable<TwoInt>, MobilityWritable<ClusterVector>>> res =
                this.instance
        ...
        final MobilityWritable<ClusterVector> outValue = res.get(0).getSecond();
