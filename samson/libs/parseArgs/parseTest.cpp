...
PaArgument paArgs[] =
{
  { "-l",       &l,          "L",             PaLong,               PaOpt,                PaND,                    PaNL,
    PaNL,
    "long"                                        },
  { "-ul",      &ul,         "UL",            PaULong,              PaOpt,                PaND,                    PaNL,
    PaNL,
    "unsigned long"                               },
  { "-il",      &il,         "IL",            PaIList,              PaOpt,                PaND,                    PaNL,
    PaNL,
    "integer list"                                },
  { "-c",       &c,          "C",             PaChar,               PaOpt,                19,                      0,
    100,
    "char"                                        },
  { "-cl",      cl,          "CL",            PaSList,              PaOpt,                PaND,                    PaNL,
    PaNL,
    "string list"                                 },
  { "-i",       &i,          "I",             PaInt,                PaOpt,                PaND,                    0,
    100,
    "integer"                                     },
  { "-ui",      &ui,         "UI",            PaIntU,               PaOpt,                19,                      0,
    100,
    "unsigned integer"                            },
  { "-s",       &s,          "S",             PaShort,              PaOpt,                PaND,                    0,
    100,
    "short"                                       },
  { "-us",      &us,         "US",            PaShortU,             PaOpt,                19,                      0,
    100,
    "unsigned short"                              },
  { "-uc",      &uc,         "UC",            PaCharU,              PaOpt,                19,                      0,
    100,
    "unsigned char"                               },
  { "-str",     string,      "STR",           PaStr,                PaOpt,                _i "DEF",
    _i "1",
    _i "E9",
    "string"                                      },
  { "-ihid",    &i2,         "HID",           PaInt,                PaHid,                19,                      0,
    100,
    "hidden"                                      },
  { "-ireq",    &i3,         "REQ",           PaInt,                PaReq,                0,                       0,
    100,
    "required"                                    },
  { "-inoul",   &i4,         "NO_UL",         PaInt,                PaOpt,                19,                      0,
    PaNL,
    "no upper limit"                              },
  { "-inoll",   &i5,         "NO_LL",         PaInt,                PaOpt,                19,                      PaNL,
    100,
    "no lower limit"                              },
  { "-idefU",   &i6,         "DEFU",          PaInt,                PaOpt,                19,                      0,
    19,
    "up limit def error"                          },
  { "-idefL",   &i7,         "DEFL",          PaInt,                PaOpt,                21,                      20,
    100,
    "low limit def error"              },
  { "-isnoul",  str2,        "SNO_UL",        PaStr,                PaOpt,                _i "19",
    _i "02",
    PaNL,              "no upper limit"                              },
  { "-isnoll",  str3,        "SNO_LL",        PaStr,                PaOpt,                _i "19",                 PaNL,
    _i "20",           "no lower limit"                              },
  { " ",        &p1,         "P1",            PaInt,                PaOpt,                19,                      PaNL,
    1000,              "parameter 1"                                 },
  { " ",        &p2,         "P2",            PaInt,                PaOpt,                19,                      PaNL,
    1000,              "parameter 2"                                 },
  { "",         &v1,         "V1",            PaInt,                PaOpt,                19,                      PaNL,
    1000,              "env var 1"                                   },
  { "-f1",      &f1,         "F",             PaFloat,              PaOpt,                _i 3.1,                  0,
    100,               "float"                                       },
  { "-d1",      &d1,         "D",             PaDouble,             PaOpt,                _i 3.3,                  0,
    100,               "double"                                      },
  { "--lmTest", &lmTest,     "",              PaBool,               PaOpt,                FALSE,
    FALSE,
    TRUE,              "test logMsg"                                 },
  { NULL,       &v2,         "V2",            PaInt,                PaOpt,                19,                      PaNL,
    1000,              "env var 2"                                   },
