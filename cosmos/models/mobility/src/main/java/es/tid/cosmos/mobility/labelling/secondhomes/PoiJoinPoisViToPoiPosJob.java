 ...
 * @author dmicol
 */
public class PoiJoinPoisViToPoiPosJob extends Job {
    private static final String JOB_NAME = "PoiJoinPoisViToPoiPos";

    public PoiJoinPoisViToPoiPosJob(Configuration conf)
            throws IOException {
        super(conf, JOB_NAME);
