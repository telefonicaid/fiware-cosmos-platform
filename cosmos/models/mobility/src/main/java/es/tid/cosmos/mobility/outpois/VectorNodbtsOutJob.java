 ...
 * @author dmicol
 */
public class VectorNodbtsOutJob extends Job {
    private static final String JOB_NAME = "VectorNodbtsOut";

    public VectorNodbtsOutJob(Configuration conf) throws IOException {
        super(conf, JOB_NAME);
