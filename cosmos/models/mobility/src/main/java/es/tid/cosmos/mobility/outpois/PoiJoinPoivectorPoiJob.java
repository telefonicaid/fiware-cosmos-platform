 ...
 * @author dmicol
 */
public class PoiJoinPoivectorPoiJob extends Job {
    private static final String JOB_NAME = "PoiJoinPoivectorPoi";

    public PoiJoinPoivectorPoiJob(Configuration conf) throws IOException {
        super(conf, JOB_NAME);
        ...
        this.setReducerClass(PoiJoinPoivectorPoiReducer.class);
    }
