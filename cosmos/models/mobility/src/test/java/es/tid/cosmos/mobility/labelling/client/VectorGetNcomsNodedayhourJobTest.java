 ...
 * @author dmicol
 */
public class VectorGetNcomsNodedayhourJobTest {
    private VectorGetNcomsNodedayhourJob instance;
    
    @Before
    public void setUp() throws IOException {
        this.instance = new VectorGetNcomsNodedayhourJob(new Configuration());
    }
