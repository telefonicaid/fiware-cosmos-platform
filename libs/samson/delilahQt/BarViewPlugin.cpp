/* ****************************************************************************
*
* FILE                     BarViewPlugin.cpp
*
* DESCRIPTION			   Plugin to visualize data coming from the queues as a Bar graph
*
*/

#include "BarViewPlugin.h"
...
BarViewPlugin::BarViewPlugin(QWidget* parent): DataViewPlugin(parent)
{
...
/*BarViewPlugin::~BarViewPlugin()
{
    //disconnect();
}*/

void BarViewPlugin::setData(std::string data)
{
...
void BarViewPlugin::onPlotReset()
{
   rateCollection.reset();
   redrawPlot();
}

void BarViewPlugin::onPlotNSamplesChanged()
{
