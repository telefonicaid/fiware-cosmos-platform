========================================================================
    ACTIVE TEMPLATE LIBRARY : csCFD Project Overview
========================================================================

AppWizard has created this csCFD project for you to use as the starting point for
...
csCFD.idl
    ...
    This file will be processed by the MIDL compiler to generate:
        C++ interface definitions and GUID declarations (csCFD.h)
        GUID definitions                                (csCFD_i.c)
        A type library                                  (csCFD.tlb)
        Marshaling code                                 (csCFD_p.c and dlldata.c)

csCFD.h
    This file contains the C++ interface definitions and GUID declarations of the
    items defined in csCFD.idl. It will be regenerated by MIDL during compilation.
...
StdAfx.h, StdAfx.cpp
    ...
    named csCFD.pch and a precompiled types file named StdAfx.obj.
...
csCFDps.vcxproj
	...
	dlldata.c, csCFD_i.c and csCFD_p.c which are required
	to build the proxy/stub DLL.

csCFDps.vcxproj.filters
