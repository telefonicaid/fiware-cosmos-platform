 ...
 * @author dmicol
 */
public class AdjSwapPoiIdSt2Job extends Job {
    private static final String JOB_NAME = "AdjSwapPoiIdSt2";

    public AdjSwapPoiIdSt2Job(Configuration conf) throws IOException {
        super(conf, JOB_NAME);
        ...
        this.setReducerClass(AdjSwapPoiIdSt2Reducer.class);
    }
