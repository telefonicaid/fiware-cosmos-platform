 ...
 * @author dmicol
 */
public class ClusterAggPotPoiPoisToPoiJob extends Job {
    private static final String JOB_NAME = "ClusterAggPotPoiPoisToPoi";

    public ClusterAggPotPoiPoisToPoiJob(Configuration conf)
            throws IOException {
        super(conf, JOB_NAME);
        ...
        this.setReducerClass(ClusterAggPotPoiPoisToPoiReducer.class);
    }
