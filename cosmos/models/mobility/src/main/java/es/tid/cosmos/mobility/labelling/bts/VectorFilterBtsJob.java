 ...
 * @author dmicol
 */
public class VectorFilterBtsJob extends Job {
    private static final String JOB_NAME = "VectorFilterBts";

    public VectorFilterBtsJob(Configuration conf) throws IOException {
        super(conf, JOB_NAME);
