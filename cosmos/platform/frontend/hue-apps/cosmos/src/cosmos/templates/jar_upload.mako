...
${shared.simple_header('Upload new custom JAR')}

<div class="prompt_popup">
    <form action="/cosmos/jars/upload" method="POST" 
          enctype="multipart/form-data">
	<h4 class="jframe-hidden">Upload new custom JAR</h4>
        ...
        <p>
            ...
            <label for="hdfs_file">JAR file</label>
    ...
    custom JAR upload, please visit <a href="http://get.adobe.com/flashplayer/"
