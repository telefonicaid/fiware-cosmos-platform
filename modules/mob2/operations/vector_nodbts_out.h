...
#ifndef _H_SAMSON_mob2_vector_nodbts_out
#define _H_SAMSON_mob2_vector_nodbts_out
...
namespace mob2{
	...
	class vector_nodbts_out : public samson::ParserOut
	{
        //Inputs
        TwoInt node_bts;
        Cluster cluster;
...
extendedHelp: 		Parse out of a vector
        ...
        size_t total = 0;
                ...
                total += snprintf( output+total, MAX_STR_LEN,"%lu|%lu|%d|%d|%f",node_bts.num1.value,node_bts.num2.value,cluster.label.value,cluster.labelgroup.value,cluster.distance.value);
