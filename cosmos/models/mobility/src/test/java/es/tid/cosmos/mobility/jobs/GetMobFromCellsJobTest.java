...
import es.tid.cosmos.mobility.jobs.GetMobFromCellsJob;
 ...
 * @author dmicol
 */
public class GetMobFromCellsJobTest {
    private GetMobFromCellsJob instance;
    
    @Before
    public void setUp() throws IOException {
        this.instance = new GetMobFromCellsJob(new Configuration());
    }
