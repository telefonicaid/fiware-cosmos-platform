...
namespace sna_light{
	...
	class VectorClique_base : public ss::DataInstance{

	public:
	::ss::sna_light::Clique *items;
	int items_length;
	int items_max_length;

	VectorClique_base() : ss::DataInstance(){
		items_length=0;
		items_max_length=0;
		items = NULL;
	}
	...
	void itemsSetLength(int _length){
		if( _length > items_max_length){ 
			::ss::sna_light::Clique *_previous = items;
			...
			items = new ::ss::sna_light::Clique[items_max_length ];
			if( _previous ){
