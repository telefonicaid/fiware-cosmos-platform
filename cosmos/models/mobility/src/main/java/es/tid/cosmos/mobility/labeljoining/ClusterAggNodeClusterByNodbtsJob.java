 ...
 * @author dmicol
 */
public class ClusterAggNodeClusterByNodbtsJob extends Job {
    private static final String JOB_NAME = "ClusterAggNodeClusterByNodbts";

    public ClusterAggNodeClusterByNodbtsJob(Configuration conf)
            throws IOException {
        super(conf, JOB_NAME);
