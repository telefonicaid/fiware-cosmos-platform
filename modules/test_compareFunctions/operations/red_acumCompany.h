...
#ifndef _H_SAMSON_test_compareFunctions_red_acumCompany
#define _H_SAMSON_test_compareFunctions_red_acumCompany
...
input: test_compareFunctions.User system.Void compareKeyFunction=compare_by_company 
