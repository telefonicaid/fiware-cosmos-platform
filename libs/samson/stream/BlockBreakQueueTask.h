...
namespace samson {
    ...
    namespace stream
    {
        ...
        class BlockBreakQueueTask : public SystemQueueTask
        {
            ...
            std::string queue;              // Target queue to send generated packets
            
            std::vector<KVRange> ranges;    // Ranges about how to divide input blocks
            
            std::vector<engine::Buffer*> outputBuffers;  // Ouput buffers generated by this operation
            
        public:
            
            BlockBreakQueueTask( size_t _id , std::string queue );
            
            void addKVRange( KVRange range );
