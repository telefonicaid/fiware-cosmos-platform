 ...
 * @author dmicol
 */
public class AdjAddUniqueIdPoiToPoiNewJob extends Job {
    private static final String JOB_NAME = "AdjAddUniqueIdPoiToPoiNew";

    public AdjAddUniqueIdPoiToPoiNewJob(Configuration conf) throws IOException {
        super(conf, JOB_NAME);
