...
DataViewPlugin::DataViewPlugin(QWidget* parent): QFrame(parent)
{
 ...
 */   
    ...
    plotNSamples = new QLineEdit(this);
...
void DataViewPlugin::setData(std::string data)
{
...
void DataViewPlugin::redrawPlot()
{
...
void DataViewPlugin::onPlotReset()
{
   rateCollection.reset();
   redrawPlot();
}

void DataViewPlugin::onPlotNSamplesChanged()
{
