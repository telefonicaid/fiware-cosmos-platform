...
import es.tid.cosmos.mobility.jobs.ParseAdjacentsJob;
 ...
 * @author dmicol
 */
public class ParseAdjacentsJobTest {
    private ParseAdjacentsJob instance;
    
    @Before
    public void setUp() throws IOException {
        this.instance = new ParseAdjacentsJob(new Configuration());
    }
