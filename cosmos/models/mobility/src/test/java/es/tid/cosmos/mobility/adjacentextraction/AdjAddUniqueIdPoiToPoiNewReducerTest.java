...
public class AdjAddUniqueIdPoiToPoiNewReducerTest {
    private ReduceDriver<LongWritable, TypedProtobufWritable<Poi>,
    ...
    public void testReduce() throws IOException {
        ...
        List<Pair<ProtobufWritable<TwoInt>, TypedProtobufWritable<PoiNew>>> result =
                this.driver
        ...
        TypedProtobufWritable<PoiNew> valueWrapper = result.get(0).getSecond();
