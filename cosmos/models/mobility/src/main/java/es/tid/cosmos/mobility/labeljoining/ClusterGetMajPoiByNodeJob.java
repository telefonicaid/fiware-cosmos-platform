 ...
 * @author dmicol
 */
public class ClusterGetMajPoiByNodeJob extends Job {
    private static final String JOB_NAME = "ClusterGetMajPoiByNode";

    public ClusterGetMajPoiByNodeJob(Configuration conf) throws IOException {
        super(conf, JOB_NAME);
