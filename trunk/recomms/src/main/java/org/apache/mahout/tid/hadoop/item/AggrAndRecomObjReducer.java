...
public final class AggrAndRecomObjReducer
        extends
        Reducer<VarLongWritable, PrefAndSimilarityColumnWritable, Text, BSONObject> {
    ...
    private void writeRecommendedItems(VarLongWritable userID,
        ...
        if (!topKItems.isEmpty()) {
            ...
            LuserId.set(userID.toString());

            context.write(LuserId,
                    new RecommsWritable(topKItems.retrieve())
                            .toObject());
