...
#define TF(b) ((b == true) ? "true" : "false")
  ...
  void SamsonWorkerRest::process_synchronized( au::SharedPointer<au::network::RESTServiceCommand> command )
  {
    ...
    au::SharedPointer<DataInstance> reference_key_data_instance((DataInstance*)key_data->getInstance());
    au::SharedPointer<DataInstance> key_data_instance          ((DataInstance*)key_data->getInstance());
    au::SharedPointer<DataInstance> value_data_instance        ((DataInstance*)value_data->getInstance());
