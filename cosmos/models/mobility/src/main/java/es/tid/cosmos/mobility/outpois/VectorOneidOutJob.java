 ...
 * @author dmicol
 */
public class VectorOneidOutJob extends Job {
    private static final String JOB_NAME = "VectorOneidOut";

    public VectorOneidOutJob(Configuration conf) throws IOException {
        super(conf, JOB_NAME);
        ...
        this.setReducerClass(VectorOneidOutReducer.class);
    }
