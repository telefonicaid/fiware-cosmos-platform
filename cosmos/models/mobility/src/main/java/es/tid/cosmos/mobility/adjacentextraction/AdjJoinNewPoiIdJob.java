 ...
 * @author dmicol
 */
public class AdjJoinNewPoiIdJob extends Job {
    private static final String JOB_NAME = "AdjJoinNewPoiId";

    public AdjJoinNewPoiIdJob(Configuration conf) throws IOException {
        super(conf, JOB_NAME);
        ...
        this.setReducerClass(AdjJoinNewPoiIdReducer.class);
    }
