 ...
 * @author dmicol
 */
public class ConvertClusterVectorToMobDataByTwoIntJob extends Job {
    private static final String JOB_NAME =
            "ConvertClusterVectorToMobDataByTwoInt";

    public ConvertClusterVectorToMobDataByTwoIntJob(Configuration conf)
            throws IOException {
        super(conf, JOB_NAME);
        ...
        this.setReducerClass(ConvertClusterVectorToMobDataByTwoIntReducer.class);
    }
