 ...
 * @author dmicol
 */
public class ClusterCountMajPoiByNodeJob extends Job {
    private static final String JOB_NAME = "ClusterCountMajPoiByNode";

    public ClusterCountMajPoiByNodeJob(Configuration conf) throws IOException {
        super(conf, JOB_NAME);
        ...
        this.setReducerClass(ClusterCountMajPoiByNodeReducer.class);
    }
