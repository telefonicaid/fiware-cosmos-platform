	...
	public int run(String[] args) throws Exception {
		...
		if (mongoInput) {
			...
			Job itemIDIndex = prepareJob(getOutputPath(ITEMID_INDEX),
					...
					ItemIDIndexObjMapper.class, VarIntWritable.class,
					VarLongWritable.class, ItemIDIndexObjReducer.class,
					VarIntWritable.class, VarLongWritable.class,
					SequenceFileOutputFormat.class);

			itemIDIndex.setCombinerClass(ItemIDIndexObjReducer.class);
		...
		Job toUserVectors = prepareJob(getOutputPath(EVENTSW),
				...
				ToElementPrefsMapper.class, VarLongWritable.class,
