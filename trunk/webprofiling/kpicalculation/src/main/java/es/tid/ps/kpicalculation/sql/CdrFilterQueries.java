...
public class CdrFilterQueries {
    final static public String CLEAN_BANNED_EXTENSIONS = "INSERT OVERWRITE TABLE CLEAN_LOG_ROWS_EXT "
            + "SELECT "
            + "a.* "
            + "FROM "
            + "log_rows a "
            ...
            + "WHERE " + "b.extension_id is NULL";

    final static public String NORMALISE_LOGS = "INSERT OVERWRITE TABLE NORMALISED_LOG_ROWS "
            + "select "
    ...
    final static public String CLEAN_3RD_PARTY_DOMAINS = "INSERT OVERWRITE TABLE PREP_LOG_ROWS_TPDOM "
            + "SELECT "
    ...
    final static public String CLEAN_PERSONAL_DOMAINS = "INSERT OVERWRITE TABLE PREP_LOG_ROWS_PIDOM "
            + "SELECT "
            + "a.* "
            + "from "
    ...
    final static public String GENERATE_PAGE_VIEWS = "INSERT OVERWRITE TABLE PAGE_VIEWS "
            + "select "
            ...
            + "method, http_status " + "from " + "PREP_LOG_ROWS_PIDOM";
}
