...
namespace samson {
namespace stream {
WorkerTaskBase::WorkerTaskBase(size_t id, const std::string& name , const std::string& operation )
...
size_t WorkerTaskBase::get_id() const{
  return id_;
}

std::string WorkerTaskBase::name() const{
  return name_;
}
  std::string WorkerTaskBase::operation() const {
    return operation_;
  }
