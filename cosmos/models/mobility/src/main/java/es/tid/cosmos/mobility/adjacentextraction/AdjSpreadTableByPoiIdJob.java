 ...
 * @author dmicol
 */
public class AdjSpreadTableByPoiIdJob extends Job {
    private static final String JOB_NAME = "AdjSpreadTableByPoiId";

    public AdjSpreadTableByPoiIdJob(Configuration conf) throws IOException {
        super(conf, JOB_NAME);
        ...
        this.setReducerClass(AdjSpreadTableByPoiIdReducer.class);
    }
