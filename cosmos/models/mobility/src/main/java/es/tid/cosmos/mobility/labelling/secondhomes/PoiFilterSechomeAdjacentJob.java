 ...
 * @author dmicol
 */
public class PoiFilterSechomeAdjacentJob extends Job {
    private static final String JOB_NAME = "PoiFilterSechomeAdjacent";

    public PoiFilterSechomeAdjacentJob(Configuration conf)
            throws IOException {
        super(conf, JOB_NAME);
        ...
        this.setReducerClass(PoiFilterSechomeAdjacentReducer.class);
    }
