 ...
 * @author dmicol
 */
public class ExportPoiJoinSechomeResultsToTextJob extends Job {
    private static final String JOB_NAME = "ExportPoiJoinSechomeResultsToText";

    public ExportPoiJoinSechomeResultsToTextJob(Configuration conf)
            throws IOException {
        super(conf, JOB_NAME);
        ...
        this.setReducerClass(ExportPoiJoinSechomeResultsToTextReducer.class);
    }
