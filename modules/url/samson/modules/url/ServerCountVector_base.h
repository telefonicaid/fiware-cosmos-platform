		...
		{ // Comparing vector serversCount
			...
			*offset2 += samson::staticVarIntParse( data2+(*offset2) , &_length2 );
			...
			{ // comparing serversCount[i]
				...
				if( tmp != 0) return tmp;
			}   //  serversCount[i] compared 
		}   // vector serversCount compared 
		{ // comparing countRef
