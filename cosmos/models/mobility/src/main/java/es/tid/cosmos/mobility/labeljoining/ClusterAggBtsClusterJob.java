 ...
 * @author dmicol
 */
public class ClusterAggBtsClusterJob extends Job {
    private static final String JOB_NAME = "ClusterAggBtsCluster";

    public ClusterAggBtsClusterJob(Configuration conf)
            throws IOException {
        super(conf, JOB_NAME);
        ...
        this.setReducerClass(ClusterAggBtsClusterReducer.class);
    }
