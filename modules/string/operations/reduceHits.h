...
#ifndef _H_SAMSON_string_reduceHits
#define _H_SAMSON_string_reduceHits
...
namespace string{
	...
	class reduceHits : public samson::Reduce
	{
	  ...
	  samson::system::Hit hit;
	  samson::string::HitsState hitsState;
...
input: system.UInt system.Hit  
input: system.UInt string.HitState  
output: system.UInt string.HitState
