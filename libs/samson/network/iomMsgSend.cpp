...
#include "logMsg/traceLevels.h"        // LmtWrite, ...

#include "engine/Buffer.h"				// samson::Buffer
#include "engine/MemoryManager.h"      // MemoryManager
#include "samson/network/Endpoint.h"           // Endpoint
#include "samson/network/Message.h"            // Message::Header, MessageCode, MessageType, ...
#include "samson/network/Packet.h"             // Packet
#include "samson/network/iomMsgSend.h"         // Own interface
...
* partWrite - 
*/
static int partWrite(samson::Endpoint* to, void* dataP, int dataLen, const char* what)
{
	int    nb;
	int    tot  = 0;
...
(
	...
	samson::Message::MessageType    type,
	void*                       data,       
	int                         dataLen,    
