 ...
 * @author dmicol
 */
public class ConvertNullToMobDataJob extends Job {
    private static final String JOB_NAME = "ConvertNullToMobData";

    public ConvertNullToMobDataJob(Configuration conf)
            throws IOException {
        super(conf, JOB_NAME);
        ...
        this.setReducerClass(ConvertNullToMobDataReducer.class);
    }
