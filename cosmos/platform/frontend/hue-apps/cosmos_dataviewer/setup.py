...
setup(
  ...
  entry_points = { 'desktop.sdk.application': 'cosmos_dataviewer=cosmos_dataviewer' },
  zip_safe = False,
  package_data = {
    # Include static resources.  Package_data doesn't
    # deal well with directory globs, so we enumerate
    # the files manually.
    'cosmos_dataviewer': expand_package_data(
      ["src/cosmos_dataviewer/templates", "src/cosmos_dataviewer/static"],
      "src/cosmos_dataviewer/")
  }
)
