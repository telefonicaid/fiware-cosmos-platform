 ...
 * @author dmicol
 */
public class AdjUpdatePoisTableJob extends Job {
    private static final String JOB_NAME = "AdjUpdatePoisTable";

    public AdjUpdatePoisTableJob(Configuration conf) throws IOException {
        super(conf, JOB_NAME);
