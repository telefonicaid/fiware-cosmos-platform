...
#ifndef _H_SAMSON_sna_light_VectorClique_BASE
#define _H_SAMSON_sna_light_VectorClique_BASE
...
namespace sna_light{
	...
	class VectorClique_base : public samson::DataInstance{
	...
	VectorClique_base() : samson::DataInstance(){
		items_length=0;
		items_max_length=0;
		items = NULL;
	}
	...
	void copyFrom( VectorClique_base *other ){
