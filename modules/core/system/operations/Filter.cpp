...
namespace samson{
    namespace system{
        ...
        SourceFunction* SourceFunction::getSourceForFunction( std::string function_name , au::vector<Source>& _input_sources )
        {
            ...
            if( token_vector->checkNextNextTokenIs("(") )
            {
                ...
                while( true )
                {
                    ...
                    else if( token->is(")") )
                    {
                        // end of vector
                        token_vector->popToken();
                        return SourceFunction::getSourceForFunction(token_function_name->content , source_components);
                    }
