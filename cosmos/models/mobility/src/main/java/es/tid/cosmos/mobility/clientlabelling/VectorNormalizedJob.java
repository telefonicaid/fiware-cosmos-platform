 ...
 * @author dmicol
 */
public class VectorNormalizedJob extends Job {
    private static final String JOB_NAME = "VectorNormalized";

    public VectorNormalizedJob(Configuration conf) throws IOException {
        super(conf, JOB_NAME);
        ...
        this.setReducerClass(VectorNormalizedReducer.class);
    }
