...
import es.tid.cosmos.mobility.jobs.GetMobFromCdrsJob;
 ...
 * @author dmicol
 */
public class GetMobFromCdrsJobTest {
    private GetMobFromCdrsJob instance;
    
    @Before
    public void setUp() throws IOException {
        this.instance = new GetMobFromCdrsJob(new Configuration());
    }
