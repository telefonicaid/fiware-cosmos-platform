 ...
 * @author dmicol
 */
public class ClusterAggPotPoiPoisToClusterJob extends Job {
    private static final String JOB_NAME = "ClusterAggPotPoiPoisToCluster";

    public ClusterAggPotPoiPoisToClusterJob(Configuration conf)
            throws IOException {
        super(conf, JOB_NAME);
        ...
        this.setReducerClass(ClusterAggPotPoiPoisToClusterReducer.class);
    }
