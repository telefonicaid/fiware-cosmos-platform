 ...
 * @author dmicol
 */
public class ConvertClusterToMobDataByTwoIntJob extends Job {
    private static final String JOB_NAME = "ConvertClusterToMobDataByTwoInt";

    public ConvertClusterToMobDataByTwoIntJob(Configuration conf)
            throws IOException {
        super(conf, JOB_NAME);
